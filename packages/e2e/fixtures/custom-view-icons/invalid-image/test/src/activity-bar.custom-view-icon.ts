...
const extensionId = 'test.custom-view-icon-invalid-image'
const viewId = 'test.views.customIconInvalidImage'
const title = 'Custom Invalid Image Icon'
const iconPath = 'invalid.png'
